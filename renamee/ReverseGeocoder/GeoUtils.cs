    ...
    internal static class GeoUtils
    {
        public static FeatureClass ToFeatureClass(this string classCode)
        {
            ...
            switch (classCode[0])
            {
                ...
                default: return FeatureClass.GeographicLandmark; //throw new ArgumentException("Invalid Feature Class");
            }
        }
        ...
        public static char ToFeatureCode(this FeatureClass featureClass)
        {
            switch (featureClass)
            {
                ...
                default: return 'T'; //throw new ArgumentException("Invalid Feature Class");
            }
        }
